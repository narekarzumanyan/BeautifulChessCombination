...
namespace ChessLibrary
{
	...
	public class Game
	{
		...
		public Player m_WhitePlayer;	    // White Player objectg
		public Player m_BlackPlayer;	    // Black player object
        public Stack result;
        ...
        public void XmlDeserialize(XmlNode xmlGame)
        {
            ...
            GameTurn = (XMLHelper.GetNodeText(xmlGame, "GameTurn") == "Black") ? Side.SideType.Black : Side.SideType.White;
        ...
        public ArrayList GetLegalMoves1(Cell source)
        {

            return m_Rules.GetLegalMoves1(source);
        }
        ...
        {
            int MoveResult;
            if (this.Board[source].piece == null || this.Board[source].piece.Side ==null)
            {
                MessageBox.Show("ERROR MOVE");
                MoveResult = -1;
                return MoveResult;
            }
