...
namespace Chess
{
	...
	public class Images
	{
		...
		public void LoadImages(string SourceDir)
		{
			...
			m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir+"Black.png"));
			m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir+"White.png"));
			// Read and store the white pieces images
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "king.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "queen.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "bishop.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "knight.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "rook.png"));
			m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir+"pawn.png"));
			// Read and store the black pieces images
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "king_2.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "queen_2.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "bishop_2.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "knight_2.png"));
            m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir + "rook_2.png"));
			m_ImageList.Add(System.Drawing.Image.FromFile(SourceDir+"pawn_2.png"));
			// Read and store the image black and white image paths
